...
# Update 01/20/2019
I've added the vision of the categories and tags on each post, and the tags on post list

# Update 01/19/2019
I've added the choice of the sidebar navigation from _config.yaml

# Update 01/18/2019
I've added the choice of the main text / background colors from _config.yaml
